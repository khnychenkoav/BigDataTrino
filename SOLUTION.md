...
В ClickHouse создаются измерения клиентов, продавцов, магазинов, поставщиков, продуктов, питомцев и дат. Факт reports.fact_sales хранит ссылки на эти измерения, исходную сумму продажи, рассчитанную сумму product_price * sale_quantity и флаг качества is_total_consistent
